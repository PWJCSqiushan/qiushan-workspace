...
const routes:Record<string,Record<string,(request:Request)=>Promise<Response>>>={'/api/session':sessionRoute,'/api/sync':syncRoute,'/api/mutations':mutationsRoute,'/api/transfer':transferRoute,'/api/backups':backupsRoute,'/api/backup-status':backup_statusRoute,'/api/workspace':workspaceRoute};
export default {
